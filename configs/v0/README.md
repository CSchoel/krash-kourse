...
```bash
LT_NODE_IP=$(kubectl get pods -l app=languagetool --no-headers -o wide | awk '{print $6}')
curl $LT_NODE_IP:8081/v2/languages
curl $LT_NODE_IP:8081/v2/check -d text="Its fine." -d language=en
```
